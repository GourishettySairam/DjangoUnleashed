...
from .views import StartupDelete, TagDelete, tag_detail, tag_list, startup_list, startup_detail, tag_create, TagCreate, StartupCreate, NewsLinkCreate, NewsLinkUpdate, TagUpdate, StartupUpdate, NewsLinkDelete
